...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMVC.Models.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebMVC.Models.Quantity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebMVC.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebMVC.Models.RecipeCategory", b =>
                {
            ...
            modelBuilder.Entity("WebMVC.Models.RecipeIngredient", b =>
                {
                    b.Property<int>("RecipeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebMVC.Models.RecipeStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebMVC.Models.RecipeCategory", b =>
                {
                    ...
                    b.HasOne("WebMVC.Models.Recipe", "Recipe")
                        .WithMany("RecipeCategories")
            ...
            modelBuilder.Entity("WebMVC.Models.RecipeIngredient", b =>
                {
                    b.HasOne("WebMVC.Models.Ingredient", "Ingredient")
                        .WithMany("RecipeIngredients")
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebMVC.Models.Quantity", "Quantity")
                        .WithMany("RecipeIngredients")
