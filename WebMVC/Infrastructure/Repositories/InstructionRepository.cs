...
namespace WebMVC.Infrastructure.Repositories
{
    public class InstructionRepository(AppDbContext appDbContext) : IInstructionRepository
    {
        ...
        public async Task<IEnumerable<Instruction>> GetAllAsync(IngredientQuery query)
        {
            ...
            {
                instructions = instructions.Where(i => i.Description.Contains(query.SearchText, StringComparison.CurrentCultureIgnoreCase));
            }
